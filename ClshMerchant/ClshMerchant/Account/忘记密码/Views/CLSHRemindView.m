...
- (KBLabel *)verificationLabel{
    ...
    if (!_verificationLabel) {
        ...
        _verificationLabel.font = [UIFont systemFontOfSize:14*AppScale];
        _verificationLabel.textColor = systemColor;
        _verificationLabel.type = bottomLine;
        _verificationLabel.lineColor = systemColor;
        _verificationLabel.labelFont = [UIFont systemFontOfSize:14*AppScale];
...
- (UIButton *)regist{
    ...
    if (!_regist) {
        ...
        [_regist setTitle:@"确认重置" forState:(UIControlStateNormal)];
